...
export const Insertar = () => {
  ...
  return (
    <div className="w3-container">
      ...
      <form
        className="w3-container w3-card-4 w3-light-grey w3-text-green w3-margin"
      ...
      <form
        className="w3-container w3-card-4 w3-light-grey w3-text-yellow w3-margin"
        onSubmit={handleSubmitEmpleado}
      >
        <h2>Agregar Empleado</h2>
        <p>
          <label className="w3-text-yellow">
      ...
      <form
        className="w3-container w3-card-4 w3-light-grey w3-text-red w3-margin"
